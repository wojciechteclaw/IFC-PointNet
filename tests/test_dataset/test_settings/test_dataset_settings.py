...
@pytest.mark.parametrize("ifc_classes, number_of_points_per_mesh, minimum_number_of_items_for_class, expected_dataset_name", [
	(['ifcbeam', 'ifcdoor', 'ifcflowfitting', 'ifcflowsegment', 'ifcfurnishingelement', 'ifcopeningelement',
	 ...
	 2048,
	 50,
	"N-no_normalization_5_classes_with_2048_points_per_mesh-min_50_items_per_class"),
	
	([],
	 1024,
	 50,
	 "N-no_normalization_5_classes_with_1024_points_per_mesh-min_50_items_per_class"),
	
	([],
	 2137,
	 0,
	 "N-no_normalization_18_classes_with_2137_points_per_mesh-min_0_items_per_class"),
	
	(['ifcbeam', 'ifcdoor', 'ifcflowfitting', 'ifcflowsegment', 'ifcfurnishingelement', 'ifcopeningelement',
	  'ifcwallstandardcase'],
	 841,
	 100,
	 "N-no_normalization_2_classes_with_841_points_per_mesh-min_100_items_per_class"),
	([],
	 700,
	 100,
	 "N-no_normalization_2_classes_with_700_points_per_mesh-min_100_items_per_class"),
])
